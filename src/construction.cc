...
G4VPhysicalVolume *MyDetectorConstruction::Construct() {
    ...
    NaITl->AddElement(Tl, 0.1*perCent);
    ...
    G4LogicalVolume     *logicScintillator = new G4LogicalVolume(solidScintillator, NaITl, "logicScintillator");
    ...
    G4VPhysicalVolume   *physCase5  = new G4PVPlacement(0, G4ThreeVector(0.*cm, 0.*cm, 8.4*cm), logicCase5, "physCase5", logicWorld, false, 0, true);
